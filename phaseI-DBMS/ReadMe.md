...
For `Name` call it `gautamSG`
enter the same for description or `gautam subnet group`
...
for `DB instance identifier` enter `gautam-db`  
...
make sure `Subnet Groups` is set to `gautamSG`  
